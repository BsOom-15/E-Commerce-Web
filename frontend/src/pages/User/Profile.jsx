...
const Profile = () => {
    ...
    return (
        <div 
        className='container mx-auto p-4 mt-[10rem]'
        >
        <div className="flex justify-center align-center md:flex md:space-x-4 ">
            ...
            >
                <div className="mb-4">
                    <label
                    className='block mb-2'>Name
                    </label>
                    <input type="text" 
                    placeholder='Enter Name'
                    className='form-input p-4 rounded-sm w-full bg-black'
                    value={username}
                ...
                <div className="mb-4">
                    <label
                    className='block mb-2'>Confirm Password
                    </label>
                    <input type="password" 
