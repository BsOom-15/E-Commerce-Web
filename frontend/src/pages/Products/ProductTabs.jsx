                    ...
                    {userInfo ? (
                        <form onSubmit={submitHandeler}>
                            <div className="my-2">
                                ...
                                <select id="rating" required value={rating} onChange={(e) => setRating(e.target.value)} className="p-2 border rounded-lg xl:w-[40rem] bg-black">
                                    <option value="">Select</option>
                                    <option value="1">Inferior</option>
                                    <option value="2">Decent</option>
                                    <option value="3">Greate</option>
                            ...
                            <div className="my-2">
                                ...
                                className="p-2 border rounded-lg xl:w-[40rem] text-white bg-black caret-pink-500" ></textarea>
                            </div>

                            <button type="submit" disabled={loadingProductReview} className="bg-pink-600 py-2 px-4 rounded-lg">Submit</button>
                        </form>
                    ): (
